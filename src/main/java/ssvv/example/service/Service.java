...
import ssvv.example.repository.FileRepository;
...
public class Service {
    private final CrudRepository<String, Student> studentFileRepository;
    private final StudentValidator studentValidator;
    private final CrudRepository<String, Tema> temaFileRepository;
    private final TemaValidator temaValidator;
    private final CrudRepository<String, Nota> notaFileRepository;
     ...
     */
    public Service(CrudRepository<String, Student> studentFileRepository,
                   StudentValidator studentValidator,
                   CrudRepository<String, Tema> temaFileRepository,
                   TemaValidator temaValidator,
                   CrudRepository<String, Nota> notaFileRepository,
    ...
    public void prelungireDeadline(String nrTema, int deadline) {
        ...
        if (tema.getDeadline() >= diff) {
            ...
            if (temaFileRepository instanceof FileRepository) {
                ((FileRepository<?, ?>) temaFileRepository).writeToFile();
            }
        } else {
